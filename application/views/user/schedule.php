  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		 ...
		 <ul class="nav navbar-nav pull-left">
			<li><a href='/user/index/<?=$id?>/<?=$page?>/4/<?=date("n/Y", mktime(0, 0, 0, ($month - 1), 1, $year))?>' name='prevBtn' id='prevBtn'><i class='fa fa-chevron-left'></i></a></li>
			<li><a href='#'><?=date("F Y", mktime(0, 0, 0, $month, 1, $year))?></a></li>
			<li><a href='/user/index/<?=$id?>/<?=$page?>/4/<?=date("n/Y", mktime(0, 0, 0, ($month + 1), 1, $year))?>' name='nextBtn' id='nextBtn'><i class='fa fa-chevron-right'></i></a></li>
        </ul>
