...
<div  style="border-bottom:2px solid #0a6e8e;border-top:2px solid #0a6e8e;background:#f4f4f4;margin-top: 20px;padding-top: 16px;">
    <h2 class="admin-heading">Edit Product <?php echo $product->product_id; ?></h2>
</div>
<div class='row main-content'>
    <div class='col-md-8 col-md-offset-2' style="background: #fff;">
    	...
    	<?php echo form_open_multipart('/admin/products/edit/', array('name' => 'productform','id' => 'productform'));?>	
				...
				<div class="col-lg-12 col-md-12">
				    	<input type='submit' class='btn btn-primary pull-right formbtn' id='saveSettingsBtn' value="Update Product" />
				</div>
			<?php echo form_close();?>
			</div>
			</div>
