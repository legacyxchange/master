                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <ul class="mailbox-list">
                            ...
                            <li>
                                <a href="/admin/notifications/sent"><i class="fa fa-paper-plane"></i> Sent</a>
                            </li>
                            <li>
                                <a href="/admin/notifications/draft"><i class="fa fa-pencil"></i> Draft</a>
                            </li>
                            <li>
                                <a href="/admin/notifications/trash"><i class="fa fa-trash"></i> Trash</a>
                            </li>
                        </ul>
                        <hr>
                        <ul class="mailbox-list">
