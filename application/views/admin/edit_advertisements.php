...
<section>
<?php //var_dump($advertisement->title); exit;?>
	<div class="container">
		...
		<div role="form">
    		...
    		<input type="hidden" name="advertisement_id" value="<?php echo $advertisement->advertisement_id;?>" />
    		<input type="hidden" name="listing_id" value="<?php echo $advertisement->listing_id;?>" />
    		<input type="hidden" name="user_id" value="<?php echo $user_id;?>" />
    		<div style="margin-bottom:20px;" class="row col-lg-12 col-md-12">
        	    Please enter the total amount of ad dollars you want to spend and maximum amount per view you want to spend for this Advertisement <b>(<?php echo $advertisement->title; ?>)</b>:
    		...
    		<div style="margin-bottom:20px;" class="row col-lg-12 col-md-12">
    				<br />
    				<label for="per_click_amount">Advertisement Title</label><br />
    				<input type="text" name="title" value="<?php echo $advertisement->title;?>" />
    		</div>
    		<div style="margin-bottom:20px;" class="row col-lg-12 col-md-12">
    				<br />
    				<label for="per_click_amount">Advertisement Description</label><br />
    				<textarea rows="4" cols="60" name="description"><?php echo $advertisement->description;?></textarea>
    		</div>
