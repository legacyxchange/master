...
<div class="admin-menu" style="background:#fff;">
    ...
    <a <?php echo !empty($menu_bids) ? 'style="background:#006989;"' : ''; ?> class="btn btn-default" href="/admin/bids">MY BIDS</a>
    <a <?php echo !empty($menu_purchases) ? 'style="background:#006989;"' : ''; ?> class="btn btn-default" href="/admin/purchases">MY PURCHASES</a>
    <a <?php echo !empty($menu_sales) ? 'style="background:#006989;"' : ''; ?> class="btn btn-default" href="/admin/sales">MY SALES</a>
    <a <?php echo !empty($menu_store) ? 'style="background:#006989;"' : ''; ?> class="btn btn-default" href="/admin/store">MY STORE</a>
</div>