<!-- Begin: Content -->
      <section id="content" style="background: #ccc;" class="table-layout animated fadeIn">
            ...
            <div class="panel panel-system panel-border top mb35">
              ...
              <div class="panel-body bg-light dark">
                <div class="admin-form">
                  ...
                  <h5 class="text-muted fw400 mb10"> Google Analytics account
                    <small>(how do I set this up?)</small>
                  </h5>
                  <div class="section mbn">
                    <label class="field prepend-icon">
                      ...
                      <label for="google-insert" class="field-icon">
        ...
        <aside class="tray tray-right tray290" data-tray-height="match">
          ...
          <div class="admin-form">
            ...
            <h4> StoreFront Options</h4>

            <hr class="short">

            <h5><small>Store Name</small></h5>
