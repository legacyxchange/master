            ...
            <div class="row">
              ...
              <div class="col-xs-4 col-xs-pull-8">
                ...
                <div class="btn-group user-menu">
                  ...
                  <a href="#signup-modal" class="btn btn-link signup" data-toggle="modal">Sign Up</a></li>
                  <?php if($this->session->userdata['username']):?>
                  <a href="/logout" class="btn btn-link login" data-toggle="modal">Logout</a><div class="btn-group language-menu"> 
                  <?php else:?>
                  	<a href="#signup-modal" class="btn btn-link login" data-toggle="modal">Login</a><div class="btn-group language-menu"> 
                  <?php endif;?>       
