        	...
        	<div class="war">
                ...
                <table class="table table-condensed">
                    ...
                    <tr>
						...
						<a href="#" id="<?=$product->product_id;?>" class="edit_button" data-toggle="modal" data-target="#productsModal"><img src="/public/images/edit-admin.png" /> </a> 
						<a class="delete_button" data-toggle="modal" data-target="#modalConfirm" href="/administrator/products/delete/<?php echo $product->product_id;?>"><img src="/public/images/delete.png" /> </a> 
						</td>
                    </tr>                                       
                <?php endforeach;?> 
                </table>
