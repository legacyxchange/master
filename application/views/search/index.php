            ...
            <div
				...
				<div class="product-image item-img">
					<img
						...
						src="/products/productimg/218/<?=$listing->product_id;?>/<?=$listing->product->image;?>" />
	...
	<div class="container">
		<div class="section-header" style="margin-top: 30px;">
			<div style="text-align: center; color: #000; font-family: georgia regular; font-size: 44px; font-weight: normal;">
				Secondary Items</div>
			<div class="subtitle"
				style="margin-top: -8px; text-align: center; color: #000; font-family: georgia regular; font-size: 34px; font-weight: normal;">
