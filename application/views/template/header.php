                  			...
                  			<!--user menu-->
                    			...
                    			<a href="#signup-modal" class="btn btn-link login-mobile" data-toggle="modal"><i class="fa fa-user"></i></a>                  				
                 				...
                 				<a href="/ecommerce/account" class="btn btn-link login">My Account</a> 
                  				<?php else:?>
                  				<a href="/coming-soon" class="btn btn-link signup">Sign Up</a>
                  				<a href="/coming-soon" class="btn btn-link login">Login</a>                  	
                  				<?php endif;?>                  			      
            			...
            			<a  onclick="$('.header-search').css('height', '60px');"href="#search" class="search-form-tigger" data-toggle="search-form" data-target=".header-search">
          				...
          				<div class="navbar-collapse collapse">
            				...
            				<ul class="nav navbar-nav">              
              					...
              					<li class="link">
                					<a href="/coming-soon" class="alternate-link">Help</a>
              					</li>                           
              					<li class="nav-li"><a href="/coming-soon"><i class="fa fa-shopping-cart" style="font-size: 30px;margin-top: -10px;"></i></a></li>
            				</ul>
          				</div>
        			</div>
      			</div>
