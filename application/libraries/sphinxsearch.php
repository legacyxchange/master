...
class_exists('SphinxClient') or require_once(SPHINXSEARCH_SPARK_HOME.'/vendor/sphinxapi.php');
// class_exists('SphinxClient') or require_once(SPHINXSEARCH_SPARK_HOME.'/vendor/sphinxapi0.9.8.1.php');
